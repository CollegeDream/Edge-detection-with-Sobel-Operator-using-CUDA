...
void generate_grarray(RGB* pixel, int* gray_array, int height, int width);
...
{
	do {
		string image_archive[NUM_IMAGES] = { "lena.bmp", "marbles.bmp", "sierra_02.bmp", "snail.bmp"};
		...
		generate_grarray(pixels, gray_array, height, width);
